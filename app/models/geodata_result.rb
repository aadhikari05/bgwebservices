  ...
  def to_json(options = {})
      result = Hash.new
    	...
    	for current_site in 0...@local_sites.length
    		...
    		local_site_value.push({"fips_id"=>@county_sites[current_site]["fips_id"]})
    		local_site_value.push({"fips_class"=>@county_sites[current_site]["fips_class"]})
    		local_site_value.push({"fips_feat_id"=>@county_sites[current_site]["fips_feat_id"]})
    		local_site_value.push({"fips_st_cd"=>@county_sites[current_site]["fips_st_cd"]})
    		local_site_value.push({"fips_place_cd"=>@county_sites[current_site]["fips_place_cd"]})
    		local_site_value.push({"fips_county_cd"=>@county_sites[current_site]["fips_county_cd"]})
    	...
    	for current_site in 0...@state_sites.length
    		...
    		state_site_value.push({"fips_id"=>@county_sites[current_site]["fips_id"]})
    		state_site_value.push({"fips_class"=>@county_sites[current_site]["fips_class"]})
    		state_site_value.push({"fips_feat_id"=>@county_sites[current_site]["fips_feat_id"]})
    		state_site_value.push({"fips_st_cd"=>@county_sites[current_site]["fips_st_cd"]})
    		state_site_value.push({"fips_place_cd"=>@county_sites[current_site]["fips_place_cd"]})
    		state_site_value.push({"fips_county_cd"=>@county_sites[current_site]["fips_county_cd"]})
